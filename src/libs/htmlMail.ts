...
export const accesoConcedido = (empresa: Empresa): string => {
    let fechaExpiracion = new Date(empresa.fechaExpiracion);
    return `<!doctype html>
    <html lang="en-US">
                                    ...
                                    <tr>
                                        <td style="padding:0 35px;">
                                            ...
                                            <div
                                                ...
                                                <div class="alertHeader" style="margin:10px auto; color:rgb(97, 156, 124);">
                                                    <h3>Buenas `+empresa.razonSocial+`, se le ha concedido acceso</h3>
                                                    <p>
                                                        Nos comunicamos del Centro Comercial para informarle que se le ha permitido el uso de la plataforma hasta la fecha `+fechaExpiracion.getDate()+`/`+(fechaExpiracion.getMonth()+1)+`/`+fechaExpiracion.getFullYear()+`, si necesita algo más contactar con el administrador 
                                                    </p>
...
export const ofertaLaboral = (oferta: Oferta): string => {
    return `<!doctype html>
    <html lang="en-US">
                                    ...
                                    <tr>
                                        <td style="padding:0 35px;">
                                            ...
                                            <div
                                                ...
                                                <div class="alertHeader" style="margin:10px auto; color:rgb(97, 156, 124);">
                                                    <h3>`+oferta.vacante+`</h3>
                                                    <p>
                                                        Nos comunicamos del Centro Comercial para compartirte esta nueva oferta laboral del rubro `+oferta.areaTrabajo+`<br>
                                                        Se valorara `+ oferta.requisitosValorar+`<br>
                                                    </p>
                                                ...
                                                <div class="alertFooter" style="margin-top:20px;">
                                                    <a href="`+process.env.URL as string+`/ofertas/`+oferta.id+` "
                                                        style="border:1px solid mediumseagreen; padding:20px;text-decoration:none;border-radius:26px;color:#fff;background:mediumseagreen;">Ir a Centro Empleo</a>
                                                </div>
                                            </div>
...
export const novedadTemplate = (novedad: Novedad): string => {
    return `<!doctype html>
    <html lang="en-US">
                                        ...
                                        <td style="padding:0 35px;">
                                            ...
                                            <div
                                                ...
                                                <div class="alertHeader" style="margin:10px auto; color:rgb(97, 156, 124);">
                                                    ...
                                                    <p>
                                                        `+novedad.contenido+`<br>
                                                    </p>
                                                </div>
                                                <br>
    
                                                <div class="alertFooter" style="margin-top:20px;">
                                                    <a href="`+process.env.URL as string+`/ofertas/`+novedad.id+` "
                                                        style="border:1px solid mediumseagreen; padding:20px;text-decoration:none;border-radius:26px;color:#fff;background:mediumseagreen;">Ir a Centro Empleo</a>
                                                </div>
                                            </div>
