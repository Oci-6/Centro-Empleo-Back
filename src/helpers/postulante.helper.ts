...
export const get = async (id: string): Promise<Postulante|undefined> => {
    ...
    return await getRepository(Postulante).findOne(id,{relations: ["pais","pais.departamentos","pais.departamentos.localidades", "localidad", "localidad.departamento", "capacitacionFormacion", "conocimientoInfo", "idioma", "expLaboral", "permisosLicencias", "documentos", "preferenciaLaboral"]});
}
